...
import { Page, Main, shell, mono, Hero, HeroTitle, HeroSub, PillLink } from "../components/site";
    ...
    <Page>
      ...
      <Main>
        <Hero accent="#7C3AED" accent2="#10B981" keyLight="rgba(124,58,237,0.12)">
          ...
          <HeroSub>
            The AI stack is re-centralizing around a handful of clouds while the hardware in everyone's pocket gets fast enough not to need them. We build for
            the second curve.
          </HeroSub>
        </Hero>
        ...
        <Section eyebrow="Thesis" title="Why on-device wins" accent="abi">
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 260px), 1fr))", gap: 20 }}>
            ...
            <FeatureCard
              ...
              desc="Apple Silicon's unified memory and Neural Engine sit idle in hundreds of millions of devices. We write the software that spends them."
            />
            <FeatureCard
              accent="abbey"
              title="Zero marginal cloud cost"
              desc="Local-first inference and storage carry no per-query COGS. Unit economics improve with adoption instead of degrading."
            />
          </div>
        </Section>
        ...
        <Section eyebrow="On paper" title="The company" accent="abbey">
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 320px), 1fr))", gap: 32, alignItems: "start" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
              ...
              <div>
                <p style={{ ...mono, fontSize: 11, letterSpacing: "0.2em", color: "#7C8BA1", margin: "0 0 12px" }}>Covered by</p>
