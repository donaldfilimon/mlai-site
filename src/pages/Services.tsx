...
import { Page, Main, shell, Hero, HeroTitle, HeroSub, PillLink } from "../components/site";
    ...
    <Page>
      ...
      <Main>
        <Hero accent="#00D4FF" accent2="#10B981" keyLight="rgba(0,212,255,0.13)">
          ...
          <HeroSub>
            A small systems team, hands-on with your codebase. Engagements are scoped in weeks, measured in p50s, and end with a reproducible benchmark harness
            in your repo.
          </HeroSub>
        </Hero>
        ...
        <Section eyebrow="Engagements" title="Three ways to work with us" accent="wdbx">
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 260px), 1fr))", gap: 20 }}>
            <FeatureCard
              ...
              desc="WDBX and the ABI Framework embedded in your app — schema design, index tuning, SDK wiring, App Store review support."
            />
            <FeatureCard
              accent="abi"
              title="Benchmark validation"
              desc="Your workload, your hardware, our harness. Measured numbers with the tag to prove it — before you commit."
            />
            <FeatureCard
              accent="abbey"
              title="Private deployment"
              desc="Air-gapped and regulated environments: offline-first retrieval, inference, and audit where cloud egress is prohibited."
            />
          </div>
        </Section>
        ...
        <Section eyebrow="Fit" title="What we say no to" accent="abbey">
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 320px), 1fr))", gap: 32, alignItems: "start" }}>
            <Callout accent="abbey" label="Scope discipline">
              We don't take work that puts your data in our hands. If the engagement requires your corpus to leave your hardware, the engagement is designed
              wrong — and we'll say so.
            </Callout>
            <Callout accent="wdbx" label="Claims discipline">
              Deliverables ship with provenance-tagged numbers. Targets are framed as targets; nothing is reported as measured until it reproduces on your
              hardware.
            </Callout>
          </div>
        </Section>
