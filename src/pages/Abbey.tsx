import { Nav, Footer, StatBlock, ProvLegend, FeatureCard, PersonaCard, PullQuote, SpecList, NextUp, Section, Eyebrow } from "../ds";
    ...
    <Page>
      ...
      <Main>
        ...
        <Section
          ...
          lead="Each persona is a trained register with its own loss terms — not a prompt template."
          accent="abbey"
        >
          <PersonaCard />
