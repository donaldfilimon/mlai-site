...
export const publications = [
  {
    ...
    date: "Jun 2026",
    abstract:
      "The formal data model and scoring math behind WDBX \u2014 hierarchical vector search, temporal\u2013causal reranking, authority-weighted records, and a hash-chained audit log \u2014 as implemented in the ABI runtime.",
  },
  {
    tag: "Research",
    ...
    date: "Jun 2026",
    abstract:
      "SEA selects which durable records enter a context pack by scoring each candidate across eight independent criteria, then packing greedily under a hard token budget and a diversity constraint.",
  },
  {
    tag: "Core Architecture",
  ...
  },
  {
    ...
    date: "Mar 2026",
    abstract:
      "Allocating milliseconds across retrieval, model calls, safety checks, and UI feedback without hiding reliability work behind optimistic averages.",
  },
  {
    tag: "Research",
